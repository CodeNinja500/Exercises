...
import { AddingToCartComponent } from './components/adding-to-cart/adding-to-cart.component';
import { SearchOnTypingBeComponent } from './components/search-on-typing-be/search-on-typing-be.component';
import { AutocompliteProductsComponent } from './components/autocomplite-products/autocomplite-products.component';
...
import { AddingToCartComponentModule } from './components/adding-to-cart/adding-to-cart.component-module';
import { SearchOnTypingBeComponentModule } from './components/search-on-typing-be/search-on-typing-be.component-module';
import { AutocompliteProductsComponentModule } from './components/autocomplite-products/autocomplite-products.component-module';

@NgModule({
  imports: [RouterModule.forRoot([{ path: 'create-user-with-role', component: UserFormComponent }, { path: 'create-job', component: CreateJobComponent }, { path: ':id/cart', component: CartComponent }, { path: 'form-array', component: FormControlsComponent }, { path: ':id/new-cart', component: NewCartComponent }, { path: 'paginator', component: PaginatorComponent }, { path: 'ex-nine-one', component: ExNineOneComponent }, { path: 'ex-nine-three', component: ExNineThreeComponent }, { path: 'paginator-double-fe', component: PaginatorDoubleFeComponent }, { path: 'paginator-single-be', component: PaginatorSingleBeComponent }, { path: 'crypto-autocomplite-fe', component: CryptoAutocompliteFeComponent }, { path: 'search-on-button', component: SearchOnButtonComponent }, { path: 'search-on-typing', component: SearchOnTypingComponent }, { path: 'adding-to-cart', component: AddingToCartComponent }, { path: 'search-on-typing-be', component: SearchOnTypingBeComponent }, { path: 'autocomplite-products', component: AutocompliteProductsComponent }]), UserFormComponentModule, UsersServiceModule, CreateJobComponentModule, JobsServiceModule, CartComponentModule, CartServiceModule, FormControlsComponentModule, NewCartComponentModule, PaginatorComponentModule, FakeStoreApiServiceModule, MatDatepickerModule, ExNineOneComponentModule, ExNineThreeComponentModule, PaginatorDoubleFeComponentModule, PaginatorSingleBeComponentModule, CryptoAutocompliteFeComponentModule, CryptosServiceModule, SearchOnButtonComponentModule, SearchOnTypingComponentModule, ProductsServiceModule, AddingToCartComponentModule, SearchOnTypingBeComponentModule, AutocompliteProductsComponentModule],
